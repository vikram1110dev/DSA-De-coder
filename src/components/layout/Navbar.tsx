...
export const Navbar: React.FC<NavbarProps> = ({ onToggleSidebar }) => {
  ...
  return (
    <>
      <header className="sticky top-0 z-30 flex items-center justify-between h-[3.75rem] px-4 sm:px-6 bg-bg-primary/80 backdrop-blur-lg border-b border-border-subtle">
        ...
        <button
          ...
          className="flex items-center gap-2.5 max-w-sm w-full mx-4 px-3.5 py-2 text-sm text-text-muted bg-bg-surface border border-border-default hover:border-border-strong rounded-lg transition-colors group"
        >
        ...
        <div className="flex items-center gap-1.5">
          ...
          <Link
            href="/ai-decoder"
            className="hidden sm:flex items-center gap-1.5 px-3 py-2 text-sm font-medium text-accent bg-accent-subtle hover:bg-accent-muted border border-transparent hover:border-accent/20 rounded-lg transition-all"
          >
          ...
          <Link
            href="/progress"
            className="flex items-center gap-1.5 px-2.5 py-2 text-sm font-semibold text-accent-amber rounded-lg hover:bg-accent-amber/10 transition-colors"
          >
            <Flame className="w-4 h-4 fill-accent-amber text-accent-amber" />
