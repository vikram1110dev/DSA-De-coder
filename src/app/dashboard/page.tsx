      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            {/* Streak pill */}
            <div className="flex items-center gap-1.5 px-3.5 py-2 text-sm font-semibold text-accent-amber bg-accent-amber/10 border border-accent-amber/20 rounded-lg">
              <Flame className="w-4 h-4 fill-accent-amber text-accent-amber" />
              <span>{streak.currentStreak} day streak</span>
            </div>

            {/* Level */}
            <div className="flex items-center gap-1.5 px-3.5 py-2 text-sm font-semibold text-accent bg-accent-subtle border border-accent/10 rounded-lg">
        ...
        <div className="surface p-5 space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-base font-semibold text-text-primary">Today's Mission</h2>
            </div>
            <div className="flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="surface p-5 space-y-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-base font-semibold text-text-primary">Topic Mastery</h3>
            </div>
              ...
              {[
                ...
                <div key={item.topic} className="space-y-1">
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-medium text-text-secondary">{item.topic}</span>
